...
if(NOT TARGET aos::aos)
    ...
    # They hold translation units whose whole contribution is static
    # initializers -- absl/log:flags, which registers --v and --vmodule, is the
    # one that bites -- so an ordinary link drops them and the flags silently
    # stop existing. Linking them whole restores what a Bazel-built AOS binary
    # does. The cost is small; these archives hold only the objects Bazel
    # already force-links.
